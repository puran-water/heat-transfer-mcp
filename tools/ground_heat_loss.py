    ...
    try:
        ...
        if 'slab_on_grade' in structure_type_lower:
            if length is None or width is None:
                return json.dumps({
                    "error": "Slab requires 'length' and 'width' dimensions."
                })
            ...
            if height is None or length is None:
                return json.dumps({
                    "error": "Basement wall requires 'height' and 'length' dimensions."
                })
            ...
            if length is None or width is None:
                return json.dumps({
                    "error": "Basement floor requires 'length' and 'width' dimensions."
                })
            ...
            return json.dumps({
                "error": f"Unsupported structure_type: {structure_type}"
            })
