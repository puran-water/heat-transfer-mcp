    ...
    try:
        ...
        if None in required_inputs:
            return json.dumps({
                ...
                "required": [
                    "flow_arrangement", "hot_fluid_name", "hot_fluid_flow_rate",
                    "hot_fluid_inlet_temp", "cold_fluid_name", "cold_fluid_flow_rate",
                    "cold_fluid_inlet_temp", "overall_heat_transfer_coefficient_U",
                    "heat_transfer_area"
                ]
            })
